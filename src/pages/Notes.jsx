        ...
        return (
          <div className='boxshadow'>
            <Box sx={{ p: 0, borderRadius: 2 }}>
              ...
              <Box className="Box" sx={{ display: 'flex', gap: 2, mb: 0, flexDirection: isSmallScreen ? 'column' : 'row' }}>
...
>
  ...
  return (
    <Box className="main-container" sx={{ p: 0, m: 0 }}>
      <CssBaseline />
      <Container className="content-container" sx={{ p: 0, m: 0 }}>
        <Box
          sx={{
            borderRadius: 2,
            p: 0, // Removed padding
